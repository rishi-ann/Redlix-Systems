            ...
            <main className="flex-grow flex items-center justify-center px-4 sm:px-8 py-12">
                <div className="w-full max-w-[400px] animate-in fade-in slide-in-from-left-4 duration-700">
                    ...
                    <header className="mb-8 sm:mb-10 text-center sm:text-left">
                        <h1 className="text-xl sm:text-2xl font-normal tracking-tight text-zinc-900 dark:text-zinc-100 mb-2 whitespace-nowrap sm:whitespace-normal">
                    ...
                    {/* Login Container */}
                    <div className="p-6 sm:p-8 rounded-2xl border border-zinc-100 dark:border-zinc-900 bg-white/50 dark:bg-zinc-900/50 backdrop-blur-sm mx-2 sm:mx-0">
