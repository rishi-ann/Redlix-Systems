                        ...
                        >
                            ...
                            <div className="space-y-4">
                                <div className="space-y-1.5 text-left">
                                    <label className="text-zinc-400 text-[10px] font-bold uppercase tracking-widest px-1">Target Client Node</label>
                                    <select
                                        required
                                        value={selectedClientId}
                                        onChange={(e) => setSelectedClientId(e.target.value)}
                                        className="w-full bg-zinc-50 dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-xl px-5 py-4 text-zinc-900 dark:text-zinc-100 text-sm focus:outline-none focus:border-emerald-500 transition-all font-normal appearance-none cursor-pointer"
                                    >
