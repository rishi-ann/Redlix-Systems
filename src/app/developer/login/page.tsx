                ...
                <div className="w-full max-w-4xl animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <header className="mb-8 sm:mb-10 text-center">
                        <h1 className="text-2xl sm:text-3xl font-normal tracking-tight text-zinc-900 mb-2">
                            Developer <span className="text-red-600">Login</span>
                        </h1>
                        <p className="text-zinc-500 text-xs font-normal px-4">
                            Log in to your account to access your tools and projects.
                        </p>
                    </header>
                    ...
                    <div className="p-8 sm:p-12 border border-zinc-100 bg-white rounded-none shadow-sm mx-2 sm:mx-0">
                        <form onSubmit={handleLogin} className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-bold tracking-wider text-red-600 uppercase px-1">Password</label>
                                    <AuthInput
                                        type="password"
                                        placeholder="••••••••"
                                        value={password}
                            ...
                            <p className="text-[10px] text-zinc-400 mt-6 font-bold uppercase tracking-[0.2em] text-center leading-relaxed">
                                New here?{" "}
                                <a href="/developer/signup" className="text-red-600 hover:text-red-700 underline decoration-red-200">Create an account</a>
                            </p>
                        </form>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-10">
                        <div className="flex flex-col items-center sm:items-start">
                            ...
                            <p className="text-sm font-medium text-white/70 text-center sm:text-left max-w-md">
                                Elegant and simple tools for modern developers and high-performance teams.
                            </p>
                        </div>
